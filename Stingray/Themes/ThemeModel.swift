...
public final class ThemeModel: Identifiable {
    ...
    public var dark: Themes {
        willSet(newValue) {
            self.darkTheme = Themes.concreteThemeFromTheme(newValue)
        }
    }
    /// Represents the theme for light mode
    public var light: Themes {
        willSet(newValue) {
            self.lightTheme = Themes.concreteThemeFromTheme(newValue)
        }
    }
    ...
    public init(darkTheme: Themes, lightTheme: Themes, colorScheme: ColorScheme) {
        ...
        self.darkTheme = Themes.concreteThemeFromTheme(darkTheme)
        self.dark = darkTheme
        self.lightTheme = Themes.concreteThemeFromTheme(lightTheme)
